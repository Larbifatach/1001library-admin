...
export class Moderators extends LibraryCrud {
  ...
  constructor(
    ...
    this.library_path = 'moderators';
  }

  // Library:: Create Record 
  public library_create_record: Moderator = {} as Moderator;
  ...
  get library_create_validate(): boolean {
    return (
      ...
      //
      !this.library_create_record.salary ||
  ...
  get library_edit_validate(): boolean {
    return (
      ...
      //
      !this.library_edit_record.salary ||

...
// Library:: Interfaces
import { Downlink } from '../../../modules/library-interfaces';
// Library:: Packages
...
export class Downlinks extends LibraryCrud {
  ...
  constructor(
    ...
    this.library_path = 'downlinks';
  }

  // Library:: Create Record 
  public library_create_record: Downlink = {} as Downlink;
  ...
  // Library:: Edit Record 
  public library_uploaders_preload: any[] = [];
  public library_books_preload: any[] = [];
  public override library_modal_edit(template: any, data: any, index: number, size: 'sm' | 'lg' | 'xl' = 'lg') {
    ...
    this.library_edit_record.id_uploader = data.uploader?.id ?? null;
    this.library_uploaders_preload = data.uploader ? [data.uploader] : [];
    this.library_edit_record.id_book = data.book?.id ?? null;
    this.library_books_preload = data.book ? [data.book] : [];
  }

...
// Library:: Interfaces
import { Lang } from '../../../modules/library-interfaces';
// Library:: Packages
...
export class Categories extends LibraryCrud {
  ...
  constructor(
    ...
    this.library_path = 'langs';
  }

  // Library:: Create Record 
  public library_create_record: Lang = {} as Lang;

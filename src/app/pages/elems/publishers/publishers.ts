...
// Library:: Interfaces
import { Publisher } from '../../../modules/library-interfaces';
// Library:: Packages
...
//
@Component({
  selector: 'library-publishers',
  templateUrl: './publishers.html',
  styleUrl: './publishers.scss',
  //
  standalone: true,
...
export class Publishers extends LibraryCrud {
  ...
  constructor(
    ...
    this.library_path = 'publishers';
  }

  // Library:: Create Record 
  public library_create_record: Publisher = {} as Publisher;

...
// Library:: Interfaces
import { Year } from '../../../modules/library-interfaces';
// Library:: Packages
...
export class Years extends LibraryCrud {
  ...
  constructor(
    ...
    this.library_path = 'years';
  }

  // Library:: Create Record 
  public library_create_record: Year = {} as Year;
